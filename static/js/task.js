...
var GorillaExperiment = function() {
  ...
  var wordon, // time word is presented
      listening = false,
      resp_prompt = '<p id="prompt">PRESS PLAY WHEN READY<br>count how many times the players wearing <b id="dotColor"></b> pass the basketball<br>Please click continue when video has finished.</p>';

      if (cond[0]) {
        resp_prompt = '<p id="prompt">PRESS PLAY WHEN READY<br>Count how many times the players wearing <b>white</b> pass the basketball<br>Please click continue when video has finished.</p>';
      } else {
        resp_prompt = '<p id="prompt">PRESS PLAY WHEN READY<br>Count how many times the players wearing <b>black</b> pass the basketball<br>Please click continue when video has finished.</p>';
      }
